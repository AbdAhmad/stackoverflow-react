    ...
    return (
        <div  style={{marginBottom: "7.5%"}}>
            ...
            <div class="collapse justify-content-end navbar-collapse" id="navbarSupportedContent">
                ...
                <form class="d-flex" action="/question" method="get">
                    <input style={{width: "800px"}} class="form-control search me-2" autocomplete="off" type="search" placeholder="Search Question" name="search" aria-label="Search" />
                </form>
                <li class="nav-item">
                    <a class="nav-link" href="/profile"><button class="btn btn-success">Abdullah</button></a>
                </li>
                <li class="nav-item">
